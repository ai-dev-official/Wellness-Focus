...
export const icons: { name: IconName }[] = [
  { name: 'sports-handball', screen: 'HomeScreen' },
  { name: 'sports-motorsports', screen: 'SearchScreen' },
  { name: 'sports-football', screen: 'FavoriteScreen' },
  { name: 'sports-esports', screen: 'AddScreen' },
  { name: 'sports-kabaddi', screen: 'SettingsScreen' },
  { name: 'sports-volleyball', screen: 'BackScreen' },
];
  ...
  return (
    <View style={styles.container}>
      <View style={styles.text}>
        <Text style={styles.text1}>Wellness Focus</Text>
      </View>
        ...
        <Animated.View style={[styles.buttonContainer, buttonContainerAStyle]}>
          <View style={styles.buttonBorder}>
            <Pressable style={styles.button} onPress={handlePress}>
              ...
              <View style={styles.dialBase}></View>
            </Pressable>
          </View>
        </Animated.View>
...
const styles = StyleSheet.create({
  ...
  buttonBorder: {
    ...
    alignItems: 'center',
    justifyContent: 'center',
    width: CIRCLE_SIZE / 2.1,
    height: CIRCLE_SIZE / 2.1,
